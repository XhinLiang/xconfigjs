...
try {
  module.exports = loadConfig('local');
} catch (e) {
...
try {
  module.exports = Object.assign(module.exports, loadConfig(filename));
} catch (e) {
...
try {
  module.exports = Object.assign(module.exports, loadConfig('default'));
} catch (e) {
